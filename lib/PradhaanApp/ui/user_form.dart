...
class PradhaanForm extends StatefulWidget {
  @override
  _PradhaanFormState createState() => _PradhaanFormState();
}

class _PradhaanFormState extends State<PradhaanForm> {
  ...
  sendUserDataToDB()async{
    ...
    }).then((value) => Navigator.push(context, MaterialPageRoute(builder: (_)=>BottomNavController1()))).catchError((error)=>print("something is wrong. $error"));
  }
